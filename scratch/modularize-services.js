...
const componentsDir = 'components/services';
...
if (mainContent) {
    ...
    const names = ['ServicesHero', 'CommitmentSection', 'ServiceCategories', 'CareDetails', 'TestimonialsSection'];
    
    sections.forEach((section, index) => {
        const name = names[index] || `ServicesSection\${index}`;
