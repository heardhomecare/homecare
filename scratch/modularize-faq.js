...
const componentsDir = 'components/faq';
...
if (mainContent) {
    ...
    const names = ['FaqHero', 'FaqContent', 'FaqGetStartedSection'];
    
    sections.forEach((section, index) => {
        const name = names[index] || `FaqSection\${index}`;
        createComponent(name, section);
    });
}

console.log('FAQ components created.');
