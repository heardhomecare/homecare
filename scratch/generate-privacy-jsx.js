...
const ClonedPrivacyPage: React.FC = () => {
    return (
...
export default ClonedPrivacyPage;
`;

fs.writeFileSync('components/raw/ClonedPrivacyPage.tsx', componentTemplate);
console.log('ClonedPrivacyPage.tsx generated.');
