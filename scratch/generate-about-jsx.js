...
const ClonedAboutPage: React.FC = () => {
    return (
...
export default ClonedAboutPage;
`;

fs.writeFileSync('components/raw/ClonedAboutPage.tsx', componentTemplate);
console.log('ClonedAboutPage.tsx generated.');
