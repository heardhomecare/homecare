...
const ClonedContactPage: React.FC = () => {
    return (
...
export default ClonedContactPage;
`;

fs.writeFileSync('components/raw/ClonedContactPage.tsx', componentTemplate);
console.log('ClonedContactPage.tsx generated.');
