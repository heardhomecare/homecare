...
const ClonedCareersPage: React.FC = () => {
    return (
...
export default ClonedCareersPage;
`;

fs.writeFileSync('components/raw/ClonedCareersPage.tsx', componentTemplate);
console.log('ClonedCareersPage.tsx generated.');
