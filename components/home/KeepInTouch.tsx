          ...
          <div className="bg-white p-8 md:p-12 shadow-2xl rounded-3xl">
            <form className="space-y-6">
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full bg-[var(--brand-green)] text-white py-5 text-sm font-bold uppercase tracking-widest transition-all hover:bg-[var(--brand-tan)] hover:shadow-xl hover:-translate-y-1 cursor-pointer"
                >
                  Send Message
                </button>
              </div>
