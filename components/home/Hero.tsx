      ...
      <div className="container mx-auto px-2 sm:px-6 relative z-10 md:pt-32 md:pb-24 min-h-[calc(100vh-80px)] flex items-center justify-center">
        ...
        >
          ...
          <div className="space-y-6 md:space-y-8 w-full">
            ...
            >
              At Heard Home Care, we take a boutique approach to care throughout the Triangle area. We take the time to welcome and support compassionate caregivers who share our commitment to exceptional care, so your loved ones can experience personalized care, comfort, and peace of mind.
            </motion.p>
          </div>
